...
#define PATCH_LIB(lib, offset, hex) patchOffset((lib), string2Offset(OBFUSCATE(offset)), OBFUSCATE(hex), true)
...
#define PATCH_LIB_SWITCH(lib, offset, hex, boolean) patchOffset((lib), string2Offset(OBFUSCATE(offset)), OBFUSCATE(hex), boolean)
